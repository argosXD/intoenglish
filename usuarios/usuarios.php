...
$cadena = "<option selected disabled> Seleccione una opción ... </option>";
  ...
  if($_SESSION["id_tipo_usuario"] != "3"){
    ...
    echo "<h1> No tiene acceso a esta parte del sistema </h1>";
    return;
    ...
    $(".formU").on("click",function(){
     ...
     $("#gusuario").click(function(){
                ...
                if(validar==1){
                   ...
                   swal("Atención", "Ingrese todos los datos solicitados", "error");
                   return ;
                }

                if($("#pswN").val()!=$("#psw2N").val()){
                   swal("Atención", "Las Contraseñas deben ser identicas", "error");
                   return ; 
                }
                    ...
                    $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.status=="100"){
                                  swal("Usuario Almacenando","Exito","success");
                                       setTimeout(function(){
                                    location.reload();
                                  }, 3000);
    ...
    $("#eusuario").click(function(){
          ...
          if(validar==0){
             ...
             var formData = new FormData();
              ...
              formData.append('id_tipo_usuario',$("#tipoUsu").val());
     ...
     $.ajax({
              ...
              success: function (response) {
                  ...
                  if(response.status=="100"){
                    ...
                    $("#pswe").val("validado");
                    $("#psw2e").val("validado");
                    $("#tipoUsu").val(datos[0]["id_tipo_usuario"]);
                    $("#tipoUsu").change();
   ...
   <div class="x_panel">
     ...
     <button type="button" id="nusuario" class="btn btn-dark">Nuevo usuario </button>
      <table id="tablaArticulos"  class="table  table-hover nowrap text-center" style="width:100%">
          ...
          <?php
            $query = "SELECT * FROM usuarios  inner join  tipo_usuarios on usuarios.id_tipo_usuario = tipo_usuarios.id_tipo_usuario  where usuarios.usuario_borrado = 1 ";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-9 col-sm-9">
                <input type="password" class="form-control formUen" id="pswN" placeholder="">
                <input type="password" class="form-control formUen" id="psw2N" placeholder="Repetir Contraseña">
            </div>
          </div>
...
<div class="modal fade" id="editarUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="tabs">
             <li><a href="#tab1P">Datos Personales</a></li>
             <li><a href="#tab2P">Foto de Perfil</a></li>
        </ul>

        <div class="tab_container">
            <div class="tab_content" id="tab1P">
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nombre(s)  </label>
              <div class="col-md-9 col-sm-9">
                <input type="text" class="form-control formE" id="nombree">
            </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Apellido Paterno  </label>
              <div class="col-md-9 col-sm-9">
                <input type="text" class="form-control formE" id="ape">
            </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Apellido Materno  </label>
              <div class="col-md-9 col-sm-9">
                <input type="text" class="form-control formE" id="ame">
            </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Correo  </label>
              <div class="col-md-9 col-sm-9">
                <input type="text" class="form-control formE" id="correoe">
            </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Telefono  </label>
              <div class="col-md-9 col-sm-9">
                <input type="text" class="form-control formE" id="telefonoe">
            </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tipo de usuario  </label>
              <div class="col-md-9 col-sm-9">
                <select class="form-control formE"  id="tipoUsu">
                  <option value="1">Alumno</option>
                  <option value="3">Administrador</option>
                  <option value="2">Maestro</option>
                  <option value="505">Gratuito</option>
                </select>
             </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Contraseña  </label>
              <div class="col-md-9 col-sm-9">
                <input type="password" class="form-control " id="pswe" placeholder="">
                <input type="password" class="form-control " id="psw2e" placeholder="Repetir Contraseña">
            </div>
          </div>
            </div>
            <div class="tab_content text-center" id="tab2P">
